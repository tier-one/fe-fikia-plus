...
const approveSubs = async (token: string | undefined, subId: string | undefined) => {
    const headers = {
        'Authorization': `Bearer ${token}`,
    };

    try {
        const res = await API.patch(`/api/v1/subscriptions/${subId}/approve`, {}, { headers });
